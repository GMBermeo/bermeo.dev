...
export const experiences: TExperience[] = [
  {
    ...
    dateEnd: "Presente",
    description: [
      "Development of new solutions using Next.js, Node.js, and TailwindCSS.",
      "Updating of front-end interface of legacy systems using newer tech stack and refactoring of HTML and CSS in PHP projects following the Clean Code principles to ease maintenance.",
      "Migration, and maintenance of Azure DevOps Source Control with Git and support for the team.",
    ],
  },
  {
    locale: "br",
