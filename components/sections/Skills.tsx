...
export const Skills = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <div>
        <ul className="grid grid-flow-row grid-cols-[repeat(6,_min(fit))] grid-rows-4 gap-x-4 gap-y-3 overflow-x-auto whitespace-nowrap rounded-none bg-dracula-background p-6 pb-5 text-sm font-medium sm:rounded-lg lg:gap-y-4 lg:p-8 lg:pb-6">
          {skills.map((skill) => (
